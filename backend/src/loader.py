...
_20Newsgroups = fetch_20newsgroups(remove=("headers", "footers", "quotes"))
...
if torch.cuda.is_available():
    ...
    model = SentenceTransformer(
        "multi-qa-MiniLM-L6-cos-v1", device="cuda", cache_folder="../models"
    )
else:
    print("Using CPU")
    model = SentenceTransformer(
        "multi-qa-MiniLM-L6-cos-v1", device="cpu", cache_folder="../models"
    )
